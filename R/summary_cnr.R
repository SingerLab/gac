...
summary_cnr<- function(cnr, detailed = FALSE, display = FALSE) {
    ...
    message("*   Bray-Curtis Diss.: ", !is.null(cnr$dists$bray))
    message("*   Fisher Distance:   ", !is.null(cnr$dists$fisher))
    message("*   Combined Distance: ", !is.null(cnr$dists$combined))
    message("*   Pin Matrix:        ", !is.null(cnr$pins$pinmat))
